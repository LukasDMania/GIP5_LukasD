...
public class AppRoutes {
    ...
    public static final String PRODUCT_ANALYTICSVIEW = "analytics/products";
    public static final String STOCKADJUSTMENT_ANALYTICSVIEW = "analytics/stockadjustments";
    public static final String USER_ANALYTICSVIEW = "analytics/users";
